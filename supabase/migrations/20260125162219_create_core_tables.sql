-- migration: create core tables, enums, indexes, and rls
-- purpose: establish brew methods, generation requests, recipes, and action logs
-- affected: public.brew_methods, public.generation_requests, public.recipes, public.recipe_action_logs
-- notes: all tables have rls enabled; user-owned tables use auth.uid() policies
