...
fun GeneratedRecipesRoute(
    ...
    LaunchedEffect(requestId) {
        viewModel.handleAction(GeneratedRecipesAction.Initialize(requestId))
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { onAction(GeneratedRecipesAction.NavigateBack) }) {
        ...
        LazyColumn(
            ...
            items(uiState.recipes, key = { it.id }) { recipe ->
                GeneratedRecipeCard(
                    recipe = recipe,
                    onAccept = { onAction(GeneratedRecipesAction.AcceptRecipe(recipe.id)) },
                    onReject = { onAction(GeneratedRecipesAction.RejectRecipe(recipe.id)) },
